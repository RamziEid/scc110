...
public class GameArena extends JPanel implements Runnable, KeyListener, MouseListener, MouseMotionListener
{
    ...
    public void paint (Graphics gr)
    {
        ...
        if (!rendered)
        {
            ...
            // Create a buffer the same size of the window, which we can reuse from frame to improve performance.
     ...
     * Once a Rectangle is removed, it will no longer appear in the window.
     *
    ...
    public void keyReleased(KeyEvent e){keyAction(e,false);
    }
    ...
    /**
     * Determines if the user is currently pressing the 00 key.
